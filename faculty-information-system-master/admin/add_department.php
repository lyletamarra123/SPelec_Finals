                        ...
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <input class="form-input" type="text" id="departmentID" name="departmentID" placeholder="..." maxlength="256" required>
                                    <label for="departmentName">Department Name</label>
                                    <input class="form-input" type="text" id="departmentName" name="departmentName" placeholder="..." maxlength="256" required>
                                </div>
                            </div>
