                        ...
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <input class="form-input" type="text" id="jobID" name="jobID" placeholder="..." maxlength="256" required>

                                    <label for="jobName">Job Name</label>
                                    <input class="form-input" type="text" id="jobName" name="jobName" placeholder="..." maxlength="256" required>

                                    <label for="jobContent">Job Content</label>
                                    <textarea rows="10" class="form-input" id="jobContent" name="jobContent" placeholder="..." required></textarea>
                                </div>
                            </div>
